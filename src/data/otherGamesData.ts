...
export const OTHER_GAMES_LIST: PlayedGameItem[] = [
  ...
  },
  {
    ...
    name: "코만도스 시리즈",
    nameEn: "Commandos: Behind Enemy Lines",
    hoursPlayed: 85.0,
    genre: "실시간 잠입 전술 전략",
  ...
  },
  {
    appId: "other-cod",
    name: "콜 오브 듀티 시리즈",
    nameEn: "Call of Duty: Modern Warfare / Warzone",
    hoursPlayed: 380.0,
    genre: "시네마틱 군사 FPS",
  ...
  {
    appId: "other-pkmn-dp",
    name: "포켓몬스터 DP 디아루가·펄기아",
    nameEn: "Pokémon Diamond & Pearl",
    hoursPlayed: 180.0,
    genre: "몬스터 수집 턴제 RPG",
  ...
  },
  {
    ...
    name: "포켓몬 불가사의 던전 파랑 구조대",
    nameEn: "Pokémon Mystery Dungeon",
    hoursPlayed: 95.0,
    genre: "로그라이크 던전 RPG",
  ...
  },
  {
    appId: "other-mh4g",
    name: "몬스터 헌터 4G",
    nameEn: "Monster Hunter 4 Ultimate",
    hoursPlayed: 320.0,
    genre: "헌팅 액션 RPG",
  ...
  },
  {
    appId: "other-mhp",
    name: "몬스터 헌터 포터블",
    nameEn: "Monster Hunter Freedom / Portable 2nd G",
    hoursPlayed: 290.0,
    genre: "헌팅 액션",
  ...
  },
  {
    appId: "other-wc3",
    name: "워크래프트 3: 프로즌 쓰론",
    nameEn: "Warcraft III: The Frozen Throne",
    hoursPlayed: 590.0,
  ...
  },
  {
    appId: "other-gta5",
    name: "그랜드 테프트 오토 5",
    nameEn: "Grand Theft Auto V (GTA 5)",
    hoursPlayed: 270.0,
  ...
  },
  {
    appId: "other-akiba",
    name: "아키바스 스트립",
    nameEn: "AKIBA'S TRIP: Undead & Undressed",
    hoursPlayed: 60.0,
