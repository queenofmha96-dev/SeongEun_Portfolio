...
export const CoverLetterSection: React.FC = () => {
  return (
    <div className="space-y-6 sm:space-y-8 font-sans">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 text-xs sm:text-sm font-mono text-slate-400 px-1">
        <div className="flex items-center gap-2">
          <FileText className="w-4 h-4 text-cyan-400" />
          <span className="text-slate-300 font-semibold">지원자 양성은</span>
          <span className="text-slate-600">•</span>
          <span>사운드 디자이너 자기소개서 전문</span>
        </div>
      ...
      <div className="space-y-8 sm:space-y-10">
        ...
        <article className="rounded-2xl bg-[#0a0c16]/90 border border-slate-800/80 p-6 sm:p-8 md:p-10 shadow-lg hover:border-slate-700/80 transition-colors">
          {/* Chapter Header */}
          <header className="flex flex-col sm:flex-row sm:items-center gap-3 border-b border-slate-800/80 pb-4 sm:pb-5 mb-6 sm:mb-8">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-cyan-950/90 border border-cyan-500/50 text-cyan-300 font-mono text-xs sm:text-sm font-bold shrink-0 self-start sm:self-auto">
              <Compass className="w-3.5 h-3.5 text-cyan-400" />
              챕터 01
            </span>
            <h3 className="text-base sm:text-xl md:text-2xl font-extrabold text-white tracking-tight break-keep">
              게임과 함께 자란 나의 삶, 그리고 사운드로 이어지는 여정
            </h3>
          </header>

          {/* Paragraphs with Generous Breathing Room and Optimal Line-Height */}
          <div className="space-y-6 sm:space-y-7 text-slate-200 text-sm sm:text-base md:text-[16.5px] leading-[1.95] sm:leading-[2.1] tracking-[-0.01em] break-keep max-w-4xl">
            <p>
            ...
            <div className="mt-4 p-4 sm:p-5 rounded-xl bg-cyan-950/25 border-l-4 border-cyan-400 text-slate-100 font-medium leading-[1.95] sm:leading-[2.1]">
              <p>
        ...
        <article className="rounded-2xl bg-[#0a0c16]/90 border border-slate-800/80 p-6 sm:p-8 md:p-10 shadow-lg hover:border-slate-700/80 transition-colors">
          {/* Chapter Header */}
          <header className="flex flex-col sm:flex-row sm:items-center gap-3 border-b border-slate-800/80 pb-4 sm:pb-5 mb-6 sm:mb-8">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-amber-950/90 border border-amber-500/50 text-amber-300 font-mono text-xs sm:text-sm font-bold shrink-0 self-start sm:self-auto">
        ...
        <article className="rounded-2xl bg-[#0a0c16]/90 border border-slate-800/80 p-6 sm:p-8 md:p-10 shadow-lg hover:border-slate-700/80 transition-colors">
          ...
          <div className="space-y-6 sm:space-y-7 text-slate-200 text-sm sm:text-base md:text-[16.5px] leading-[1.95] sm:leading-[2.1] tracking-[-0.01em] break-keep max-w-4xl">
            ...
            <div className="mt-4 p-4 sm:p-5 rounded-xl bg-amber-950/20 border-l-4 border-amber-400/80 text-slate-100 font-medium leading-[1.95] sm:leading-[2.1]">
              <p>
