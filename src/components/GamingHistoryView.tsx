...
export const GameLogoBadge: React.FC<{ gameId: string }> = ({ gameId }) => {
  switch (gameId) {
    case 'pubg':
      return (
        <div className="w-11 h-11 rounded-xl bg-[#f2a900] text-black font-black font-mono text-xs flex flex-col items-center justify-center shadow-md border border-amber-300 flex-shrink-0">
          <span className="leading-none text-[12px]">PUBG</span>
          <span className="text-[6px] tracking-tighter opacity-90 font-bold">BATTLEGROUNDS</span>
        </div>
      );
    case 'valorant':
      return (
        <div className="w-11 h-11 rounded-xl bg-[#ff4655] text-white flex items-center justify-center shadow-md border border-rose-400 flex-shrink-0">
    ...
    case 'cyberpunk':
      return (
        <div className="w-11 h-11 rounded-xl bg-[#fcee0a] text-black font-black font-mono flex flex-col items-center justify-center shadow-md border border-yellow-300 flex-shrink-0">
          <span className="text-[8px] leading-tight font-extrabold tracking-widest">CYBERPUNK</span>
          <span className="text-xs font-black leading-none">2077</span>
        </div>
      );
    case 'eldenring':
      return (
        <div className="w-11 h-11 rounded-xl bg-[#12101d] border border-[#d4af37] text-[#e5c158] flex items-center justify-center shadow-md flex-shrink-0">
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
    ...
    case 'overwatch':
      return (
        <div className="w-11 h-11 rounded-xl bg-[#f99e1a] text-white flex items-center justify-center shadow-md border border-amber-300 flex-shrink-0">
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
    ...
    case 'mhw':
      return (
        <div className="w-11 h-11 rounded-xl bg-[#1b4332] border border-[#52b788] text-[#95d5b2] font-mono flex flex-col items-center justify-center shadow-md flex-shrink-0">
    ...
    case 'lol':
      return (
        <div className="w-11 h-11 rounded-xl bg-[#091428] border border-[#c8aa6e] text-[#c8aa6e] font-black font-serif text-sm flex items-center justify-center shadow-md flex-shrink-0">
          LoL
        </div>
      );
    case 'diablo':
      return (
        <div className="w-11 h-11 rounded-xl bg-[#2a0808] border border-[#800000] text-[#ff4d4d] font-serif font-black text-xs flex items-center justify-center shadow-md flex-shrink-0">
          D IV
        </div>
      );
    default:
      return (
        <div className="w-11 h-11 rounded-xl bg-slate-800 text-cyan-300 font-bold flex items-center justify-center text-xs flex-shrink-0">
          GAME
        </div>
      );
  }
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-fadeIn font-sans text-slate-100 py-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800/80 pb-4">
        ...
        <div className="flex items-center gap-2 text-xs font-mono text-amber-300 bg-slate-900 border border-slate-800 px-3 py-1.5 rounded-xl w-fit">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
        {GAMING_LOGS.map((game) => (
          <div
            key={game.id}
            className="pb-5 border-b border-slate-800/60 space-y-2.5"
          >
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              {/* Playtime Badge */}
              <span className="text-xs font-mono font-bold text-amber-300 bg-amber-950/80 border border-amber-500/40 px-2.5 py-1 rounded-lg flex-shrink-0 flex items-center gap-1">
